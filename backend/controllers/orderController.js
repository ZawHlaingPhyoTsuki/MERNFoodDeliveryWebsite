...
import dotenv from "dotenv"; // something is wrong here/ normally, we don't need to import dotenv

// Load environment variables // something is wrong here
dotenv.config();
...
const placeOrder = async (req, res) => {
  const frontend_url = "http://localhost:5174"; // Frontend URL (will be used for success and cancel URLs)
